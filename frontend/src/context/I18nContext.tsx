...
const strings: Record<Lang, Dict> = {
  ...
  am: {
    ...
    'change_password.title': 'የይለፍ ቃል ቀይር',
    'change_password.subtitle': 'የመለያዎን የይለፍ ቃል ያዘምኑ። በሚቀጥለው ጊዜ ሲገቡ ይህ ይተገበራል።',
    'change_password.current': 'አሁን ያለ የይለፍ ቃል',
    'change_password.new': 'አዲስ የይለፍ ቃል',
    'change_password.confirm': 'አዲስ የይለፍ ቃል አረጋግጥ',
    'change_password.submit': 'የይለፍ ቃል ቀይር',
    'change_password.changing': 'በመቀየር ላይ...',
    'change_password.error.required_fields': 'እባክዎ ሁሉንም መስኮቶች ይሙሉ።',
    'change_password.error.mismatch': 'አዲሱ የይለፍ ቃል እና ማረጋገጫው አይመሳሰሉም።',
    'change_password.error.too_short': 'አዲሱ የይለፍ ቃል ቢያንስ 8 ቁምፊ መሆን አለበት።',
    'change_password.error.weak': 'አዲሱ የይለፍ ቃል ፊደሎችን እና ቁጥሮችን መያዝ አለበት።',
    'change_password.error.current_incorrect': 'አሁን ያለው የይለፍ ቃል ትክክል አይደለም',
    'change_password.error.generic': 'የይለፍ ቃል መቀየር አልተሳካም።',
    'change_password.success': 'የይለፍ ቃል በተሳካ ሁኔታ ተቀይሯል።',
